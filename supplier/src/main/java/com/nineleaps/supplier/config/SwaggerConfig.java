...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Vivek Rathi", "", "vivek.rathi@nineleaps.com");
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Nineleaps", "Nineleaps Documentation", "1.0", "urn:tos",
	 ...
	 @Bean
	    public Docket api() { 
	        return new Docket(DocumentationType.SWAGGER_2)
	         ...
	         .apis(RequestHandlerSelectors.basePackage("com.nineleaps.supplier"))
